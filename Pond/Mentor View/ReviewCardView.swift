...
struct ReviewCardView: View {
  var body: some View {
    VStack {
      PBCard(backgroundColor: Color.green.opacity(0.2), border: true, borderRadius: 10, style: .default, width: 275) {
...
""")
          ...
          .frame(height: 175)
          PBAvatar(image: Image("Caitie"), name: "Caitie Rosenberg", size: .medium)
